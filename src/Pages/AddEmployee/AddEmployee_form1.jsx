...
const AddEmployee_form1 = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      <LabeledInput cls={'wd50'} type={'date'} img={false} title={'Date of Birthday'} id={'dob'} value={dob} func2={(data)=>props.changeDOB(data)} />
      ...
      <LabeledSelect cls={'wd50'}  selectedVal={props.changeGender} img={false} title={'Gender'} id={'gender'} data={[{name:'Male'},{name:'Female'}]}  />
    </React.Fragment>
  )
}
