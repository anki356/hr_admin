...
console.log(Data)
  return (
    <React.Fragment>
      ...
      <MainTable func={changeModalState}Lnk={true} link1={'interview_details'} t3={'Interview Details'} App_Btn={true}   height={true} headings={tableHeadings} keys={tableKeys}  data={data} />
