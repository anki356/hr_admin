...
console.log(Data)
  return (
    <React.Fragment>
      ...
      <MainTable func={changeModalState} Lnk={true} link1={'false'}  App_Btn={true}  height={true} headings={tableHeadings} keys={tableKeys} link2={'/attendence_history'} data={data} />
