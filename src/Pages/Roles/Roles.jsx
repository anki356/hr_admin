...
setRoles(response.data)
  ...
  return (
    <React.Fragment>
      ...
      <MainTable data={roles} height={true} Lnk={true} headings={tableHeadings} keys={tableKeys} link3={'/det'} link2={'/edit_roles'}t1='View Details' t2='Edit' lnk2={true} link1={'false'}/>
    </React.Fragment>
  )
}
