        ...
        <React.Fragment>
            ...
            <div className='uni_container'>
                <div className={classes.inner_container}>
                    ...
                    <LabeledSelect select_id={'slt'} title={'Sub Category'} img={Img} selectedVal={(data) => setSubCategory(data)} data={subCategories} />
                    </div>
                    <LabeledInput cls={true} func2={timeHandler} id={'time'} ph={'Time'} title={'Time'} img={false} type={'time'} />
                    <LabeledInput cls={true} func2={dateHandler} id={'date'} ph={'Date'} title={'Date'} type={'date'} img={false} />
                    <LabeledInput cls={true}  func2={amountHandler} mr={true} id={'amount'} ph={'Amount'} title={'Amount'} type={'text'} img={false} />
                </div>
