    ...
    return (
        <Modal wd={'470px'} isModal={modal} >
            ...
            <div className={classes.modal_data}>
                ...
                <div className={classes.modal_data_div}>Advance <span>{props.Obj.advance}</span></div>
                <div className={classes.modal_data_div}>Recall Head<span><input type="checkbox"  /></span></div>
                <div className={classes.modal_data_div}>Approval By FI<span><input type="text" /></span></div>
