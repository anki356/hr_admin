                        ...
                        {newData.map((val, index) => (
                            <tr key={index}>
                                ...
                                }
                                {
                                    props.Lnk === true ?
                                        <td>
                                            <HoverableTableActions Element={val} onClickFunc={clickHandler} link1={props.link1} Btn={props.App_Btn} link2={props.link2} t1={props.t1} t2={props.t2} t3={props.t3} link4={props.link4} t4={props.t4} />
                                        </td> : null
                                }
                                {
                                    props.Lnk2 === true ?
